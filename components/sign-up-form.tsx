  ...
  return (
    <Card className="w-full">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Sign up with your Google account</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <Button variant="outline" className="w-full bg-transparent" onClick={handleGoogleSignUp} disabled={isLoading}>
          <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
            ...
            />
            <path fill="currentColor" d="M12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
          </svg>
